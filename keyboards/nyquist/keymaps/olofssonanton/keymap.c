 ...
 */
  ...
  [_NUM] = LAYOUT( \
    ...
    ___X___, _______, ___X___, ___X___, ___X___, ___X___, ___X___, KC_P7,   KC_P8,   KC_P9,   KC_PLUS, ___X___,  \
    ___X___, _______, _______, _______, _______, ___X___, ___X___, KC_P4,   KC_P5,   KC_P6,   KC_MINS, ___X___,  \
    ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, KC_P1,   KC_P2,   KC_P3,   KC_ASTR, ___X___,  \
    ___X___, ___X___, ___X___, ___X___, _______, _______, KC_PENT, KC_P0,   KC_PDOT, ___X___, KC_SLSH, ___X___   \
  ),
