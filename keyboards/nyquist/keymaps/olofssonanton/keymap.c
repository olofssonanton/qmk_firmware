 ...
 */
  ...
  [_NUM] = LAYOUT( \
    ___X___, ___X___, ___X___, ___X___, ___X___, KC_PSCR, KC_PAUS, KC_NLCK, KC_CAPS, KC_SLCK, ___X___, ___X___,  \
    ___X___, _______, ___X___, ___X___, ___X___, ___X___, ___X___, KC_7,    KC_8,    KC_9,    KC_PLUS, ___X___,  \
    ___X___, _______, _______, _______, _______, ___X___, ___X___, KC_4,    KC_5,    KC_6,    KC_MINS, ___X___,  \
    ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, KC_1,    KC_2,    KC_3,    KC_ASTR, ___X___,  \
    ___X___, ___X___, ___X___, ___X___, _______, _______, _______, KC_0,    KC_COMM, KC_DOT,  KC_SLSH, ___X___   \
  ),
